...
object OAuth2ClientBuilders {
    ...
    fun apple(registrationId: String = "apple"): ClientRegistration.Builder {
        ...
        builder.forAppleDefaults()
            .clientName("Apple")
        return builder
    }

    fun ClientRegistration.Builder.forAppleDefaults(): ClientRegistration.Builder {
        return this.scope("name", "email")
